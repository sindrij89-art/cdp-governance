        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {benefits.map((benefit) => (
            <div
              ...
              className="group rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] p-6 transition-all hover:border-[color:var(--card-hover-border)] hover:shadow-lg hover:shadow-[color:var(--card-hover-shadow)]"
            >
              <div className="mb-4 inline-flex rounded-lg bg-[color:var(--card-icon-bg)] p-3 text-[color:var(--accent)] transition-colors group-hover:bg-[color:var(--card-icon-bg-hover)]">
                {benefit.icon}
              </div>
